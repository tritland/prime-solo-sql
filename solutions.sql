...
SELECT * FROM syntax_practice WHERE ILIKE 'Chicago';
...
Get the username and account balance of the 3 users with the highest balances, sort highest to 
lowest balance. NOTE: Research LIMIT
...
VALUES ('Nic Bade', 'San Pablo', '5', '5', '1000000');
